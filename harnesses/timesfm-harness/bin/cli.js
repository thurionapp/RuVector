...
// Generated by metaharness — the `timesfm-harness` CLI entry point.
//
// This is plain ESM JavaScript on purpose: it runs as-is via `npx timesfm-harness`
...
// "bin" + "files" fields in package.json), so `npx timesfm-harness` works the moment
...
const HARNESS_NAME = 'timesfm-harness';

/** `timesfm-harness init` — boot the kernel + host adapter and report status. */
async function init() {
...
/** `timesfm-harness doctor` — verify the install end-to-end (kernel + host resolve). */
